...
router.get('/due-for-purchase', materialController.getDueForPurchase.bind(materialController));
...
router.post('/:id/purchase', materialController.markAsPurchased.bind(materialController));
