  ...
  <div class="page">
    <main class="pa-4">
      <div class="d-flex align-center justify-space-between ga-4 mb-6">
        <v-card-title class="ma-0 text-h5">Créer une ration</v-card-title>
...
const createRation = async () => {
  ...
  const validItems = form.value.items.filter((item) => item.productId || item.quantity || item.frequency.length)
